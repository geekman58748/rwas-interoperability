...
async function main() {
    ...
    const ascRead = new ethers_1.ethers.Contract(ascAddress, ASC_READ_ABI, creditcoinProvider);
    ...
    const tx = await ascWrite.storeOwnership(proofData.chainKey, proofData.headerNumber, walletAddress, 0n, // assetId = 0
