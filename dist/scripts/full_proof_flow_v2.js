...
async function main() {
    ...
    const ascWrite = new ethers_1.ethers.Contract(ascAddress, ASC_ABI, signer);
    ...
    const tx = await ascWrite.verifyAndMintReceipt(proofData.chainKey, proofData.headerNumber, walletAddress, 0n, // assetId
    mintTxHash, true // source tx was successful
    );
    ...
    const vrs = new ethers_1.ethers.Contract(receiptAddress, VRS_ABI, creditcoinProvider);
